function tdtSortSessionv1(inFile,varargin),
...
for ic = 1:numChans,
    ...
    try
        if manThresh,
            chanSorts = tdtSortChanv2a(chanSEVs.Wav1.data,'-t',chanThresh(ic));
        else
            chanSorts = tdtSortChanv2a(chanSEVs.Wav1.data);
        end
        ...
        save(sprintf('%s/%s/Channel%d/autoSort_noAudit.mat',procDir,inFile,ic),'chanSorts');
    catch
