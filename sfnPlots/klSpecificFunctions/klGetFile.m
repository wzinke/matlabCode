function [grpSDF, grpSDFTimes, grpWaves, normMat, grpStd] = klGetFile(xlRows,varargin)
...
for ir = 1:length(xlRows),
    ...
    normMat(ir,2) = nanstd(nanmean(vSDF(:,ismember(grpSDFTimes{ir,1},blWind)),zDim(1)),[],zDim(2));
